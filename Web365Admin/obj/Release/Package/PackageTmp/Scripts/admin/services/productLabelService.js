...
web365app.factory('productLabelService', ['$q', '$http', function ($q, $http) {
    ...
    var _getListForTree = function (obj) {
        ...
        //get data from services
        $http.get('/ProductLabel/GetListForTree').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getEditForm = function (id) {
        ...
        //get data from services
        $http.get('/ProductLabel/EditForm', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/ProductLabel/Action', obj, {
    ...
    var _showAll = function (listId) {
        ...
        $http.post('/ProductLabel/ShowAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _hideAll = function (listId) {
        ...
        $http.post('/ProductLabel/HideAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
