...
{
    public class GroupServiceRepositoryBE : BaseBE<tblStepOfService>, IGroupServiceRepositoryBE
    {
        private readonly IGroupServiceDABERepository serviceDABERepository;

        public GroupServiceRepositoryBE(IGroupServiceDABERepository _serviceDABERepository)
        ...
        /// </summary>
        /// <returns></returns>
        public List<GroupOfServiceItem> GetList(out int total, string name, int currentRecord, int numberRecord,
